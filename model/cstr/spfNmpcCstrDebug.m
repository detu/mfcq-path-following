function [Tall, xmeasureAll, uAll, ObjVal, runtime] = spfNmpcCstrDebug(optProblem, system, mpciterations, N, T, tmeasure, xmeasure, u0, scr, varargin)
%SPFNMPCCSTRDEBUG Summary of this function goes here
% 
% [OUTPUTARGS] = SPFNMPCCSTRDEBUG(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2018/05/30 15:31:34 $	$Revision: 0.1 $
