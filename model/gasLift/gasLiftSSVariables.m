function [w0,lbw,ubw,lbg,ubg,g,w] = gasLiftSSVariables(par)
%GASLIFTSSVARIABLES Summary of this function goes here
% 
% [OUTPUTARGS] = GASLIFTSSVARIABLES(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2018/11/18 22:35:34 $	$Revision: 0.1 $
